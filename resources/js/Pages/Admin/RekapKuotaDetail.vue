    ...
    <MainLayout>
        ...
        <div class="relative w-full h-full">
            <div class="p-6 bg-white rounded-xl shadow-sm">
                ...
                >
                    <h2 class="text-xl font-bold">Rekap Kuota Detail Cuti</h2>
                    ...
                    >
                        ...
                        <!-- Tombol BARU: Impor Kuota (Warna Biru), diletakkan
                         di sebelah kiri tombol Export Excel -->
                        <button
                            type="button"
                            @click="openImportModal"
                            class="inline-flex items-center justify-center w-full sm:w-auto gap-2 px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-semibold text-sm text-white hover:bg-blue-700 transition ease-in-out duration-150 shadow-sm cursor-pointer"
                        >
                            <svg
                                class="w-4 h-4"
                                fill="none"
                        ...
                        <!-- Tombol Export (Tombol Asli, tidak diubah) -->
                        <a
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-sm">
                            ...
                            >
                                ...
                                <!-- Cuti Tahunan Terpakai (Warna Merah) -->
                                <td class="p-3">
            ...
            <!-- MODAL DETAIL KUOTA + RIWAYAT CUTI PEGAWAI (POSISI DIPERBAIKI
             AGAR SELALU DI TENGAH LAYAR, TIDAK PEDULI TINGGI KONTEN HALAMAN
             DI BELAKANGNYA MAUPUN LEVEL ZOOM BROWSER) — tetap memakai data
             asli 'pengajuan_cuti' & 'approval_chain' dari controller, bukan
             field placeholder. -->
            <div
                v-if="showModal"
                ...
                >
                    ...
                    <form @submit.prevent="submitImportForm">
                        ...
                        <p class="text-xs text-gray-400 mb-5">
                            Pastikan kolom pada file mengikuti format template
                            yang sudah ditentukan (NIP, Jatah Cuti, Sisa Tahun
                            Ini, Sisa Tahun Kemarin, dsb).
                        </p>
