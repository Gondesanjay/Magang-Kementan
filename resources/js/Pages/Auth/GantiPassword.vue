...
<template>
    ...
    <div
        class="min-h-screen flex flex-col items-center justify-center relative font-sans bg-gradient-to-br from-indigo-50/70 via-purple-50/40 to-blue-50/60 overflow-hidden px-4 py-8"
    >
        <!-- Background Dekoratif Lingkaran Lembut -->
        <div
            class="absolute -top-32 -left-32 w-96 h-96 bg-purple-200/30 rounded-full blur-3xl pointer-events-none"
        ></div>
        <div
            class="absolute -bottom-32 -right-32 w-96 h-96 bg-blue-200/40 rounded-full blur-3xl pointer-events-none"
        ></div>

        <!-- KARTU UTAMA GANTI KATA SANDI -->
        <div
            class="relative z-10 w-full max-w-[500px] bg-white p-8 sm:p-10 rounded-[28px] shadow-2xl shadow-indigo-500/10 border border-slate-100"
        >
            <!-- Icon 3D Shield di Bagian Atas -->
            <div class="flex flex-col items-center text-center mb-6">
                <div
                    class="w-24 h-24 mb-3 flex items-center justify-center drop-shadow-xl hover:scale-105 transition-transform duration-300"
                >
                ...
                <h1
                    class="text-2xl sm:text-[28px] font-extrabold text-slate-800 tracking-tight"
                >
                    Ganti Kata Sandi
                </h1>
            ...
            <div
                class="flex items-start gap-3 bg-[#f0f4ff] border border-blue-100 p-4 rounded-2xl mb-6 text-blue-900"
            >
                <svg
                ...
                <p class="text-xs leading-relaxed font-medium">
                    Ini adalah kali pertama Anda masuk. Demi keamanan sistem,
                    silakan ubah kata sandi bawaan Anda menjadi kata sandi baru
                    sebelum melanjutkan.
                </p>
            </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        ...
                        <button
                            ...
                            class="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors cursor-pointer"
                        >
                            <svg
                                v-if="!showPassword"
                                class="w-5 h-5"
        ...
        <div
            class="mt-6 text-center text-xs text-slate-500 flex items-center gap-1.5 relative z-10 font-medium"
        >
            <svg
